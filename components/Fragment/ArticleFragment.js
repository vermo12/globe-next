...
export default function ArticleFragment({objectData, linkData}) {
    ...
    const imgUrl = (objectData.content.mainPictureUrl?objectData.content.mainPictureUrl:'/img/nothumb.jpg')
            ...
            <div className="GLlatestStoryTop" style={{width: '100%'}}>
                ...
                <h2 className="GLstoryTitle">
                    ...
                    <Link href={objectData.url}>
                        <a>
                            {objectData.content.headline}
                        </a>
                    </Link>
                </h2>
                <p className="GLstoryByline">{objectData.authors[0]}</p>
                <h3 className="GLstorySummary">{objectData.content.summary}</h3>
